...
const sImgs = import.meta.glob("../assets/sets/ZZZ/*.webp", { eager: true });
              ...
              {Object.keys(myChars).length === 0 ? (
                ...
                myCharsWithScores.map(({ id, data, score }) => (
                  ...
                  >
                    <TableCell>
                      <img
                        src={cImgs[`../assets/char/ZZZ/${id}.webp`]?.default}
                        alt={id}
                    ...
                    {isDesktop && (
                      <TableCell>
                        {data.weapon && (
                          ...
                          >
                            <img
                              src={wImgs[`../assets/weap/ZZZ/${data.weapon}.webp`]?.default}
                              alt={data.weapon}
                      ...
                      <TableCell>
                        ...
                        >
                          {data.set1 && (
                            ...
                            >
                              <img
                                src={sImgs[`../assets/set/ZZZ/${data.set1}.webp`]?.default}
                                alt={data.set1}
                                style={{ width: 50, height: 50, objectFit: "contain", cursor: "pointer" }}
                              />
                            </Tooltip>
                          ...
                          {data.set2 && (
                            ...
                            >
                              <img
                                src={sImgs[`../assets/set/ZZZ/${data.set2}.webp`]?.default}
                                alt={data.set2}
                                style={{ width: 50, height: 50, objectFit: "contain", cursor: "pointer" }}
                              />
                            </Tooltip>
