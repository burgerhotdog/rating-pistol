...
const Save = ({
  ...
  const [newCdata, setNewCdata] = useState(() => blankCdata("WW"));
    ...
    <Modal open={Boolean(isSaveOpen)} onClose={handleCancel}>
      ...
      >
        ...
        >
          ...
          {newCid && (
            <img
              src={cImgs[`../../../assets/char/ww/${toPascalCase(newCid)}.webp`]?.default}
              alt={"char"}
          ...
          <Grid container spacing={2} sx={{ width: { xs: 256, xl: 1440 }, mt: 2 }}>
            ...
            <Grid size={{ xs: 12, xl: 4 }}>
              {isNotMobile && newCdata.weapon && (
                <img
                  src={wImgs[`../../../assets/weap/ww/${toPascalCase(newCdata.weapon)}.webp`]?.default}
                  alt={"weap"}
