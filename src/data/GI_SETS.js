const GI_SETS = {
  ...
  [`Scroll of the Hero of Cinder City`]: {
    desc: [
      `2-Pc: When a nearby party member triggers a Nightsoul Burst, the equipping character regenerates 6 Elemental Energy.`,
  ...
  [`Pale Flame`]: {
    desc: [
      `2-Pc: Physical DMG is increased by 25%.`,
  ...
  [`Maiden Beloved`]: {
    desc: [
      `2-Pc: Character Healing Effectiveness +15%`,
  ...
  [`Thundersoother`]: {
    desc: [
      `2-Pc: Electro RES increased by 40%.`,
