const GI_SETS = {
  ...
  "10001": {
    ...
    rarity: 4,
    desc: "2-Pc: ATK +18%.\n4-Pc: Increases Charged Attack CRIT Rate by 30%.",
  },
  "10002": {
    name: "Brave Heart",
    rarity: 4,
    desc: "2-Pc: ATK +18%.\n4-Pc: Increases DMG by 30% against opponents with more than 50% HP.",
  },
  "10003": {
    name: "Defender's Will",
    rarity: 4,
    desc: "2-Pc: DEF +30%\n4-Pc: For each different element present in your own party, the wearer's Elemental RES to that corresponding element is increased by 30%.",
  },
  "10004": {
    name: "Tiny Miracle",
    rarity: 4,
    desc: "2-Pc: All Elemental RES increased by 20%.\n4-Pc: Incoming elemental DMG increases corresponding Elemental RES by 30% for 10s. Can only occur once every 10s.",
  },
  "10005": {
    name: "Berserker",
    rarity: 4,
    desc: "2-Pc: CRIT Rate +12%\n4-Pc: When HP is below 70%, CRIT Rate increases by an additional 24%.",
  },
  "10006": {
    name: "Martial Artist",
    rarity: 4,
  ...
  "10008": {
    name: "Gambler",
    rarity: 4,
    desc: "2-Pc: Increases Elemental Skill DMG by 20%.\n4-Pc: Defeating an opponent has a 100% chance to remove Elemental Skill CD. Can only occur once every 15s.",
  },
  "10009": {
    name: "The Exile",
    rarity: 4,
  ...
  "10012": {
    name: "Scholar",
    rarity: 4,
    desc: "2-Pc: Energy Recharge +20%\n4-Pc: Gaining Elemental Particles or Orbs gives 3 Energy to all party members who have a bow or a catalyst equipped. Can only occur once every 3s.",
  },
  "10010": {
    name: "Adventurer",
    rarity: 3,
  ...
  "10011": {
    name: "Lucky Dog",
    rarity: 3,
    desc: "2-Pc: DEF increased by 100.\n4-Pc: Picking up Mora restores 300 HP.",
  },
  "10013": {
    name: "Traveling Doctor",
    rarity: 3,
    desc: "2-Pc: Increases incoming healing by 20%.\n4-Pc: Using Elemental Burst restores 20% HP.",
  },
};

export default GI_SETS;
