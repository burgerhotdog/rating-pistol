...
export const CustomRadarChart = ({ buildEntry, combinedSimEquips, isLoading }) => {
  const { gameId } = useParams();
  if (isLoading || !buildEntry[1] || !combinedSimEquips) return null;
  const buildSources = buildSourceMapList(gameId, buildEntry);
